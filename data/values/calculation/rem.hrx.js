// https://github.com/sass/sass-spec/blob/HEAD/spec/values/calculation/rem.hrx

export default [
  {
    name: 'README.md',
    data: "Most of the same behavior tested for `calc()` applies to `rem()`, but for\nterseness' sake isn't tested explicitly.\n",
  },
  {
  ...
  },
  {
    ...
    data: '@function rem($arg) {@return $arg}\na {b: rem(1)}\n',
  },
  {
  ...
  {
    name: 'negative_zero_and_positive_infinity/input.scss',
    data: '@use "sass:math";\na {b: math.div(1, rem(-0, infinity))}\n',
  },
  {
    name: 'negative_zero_and_positive_infinity/output.css',
    data: 'a {\n  b: calc(-infinity);\n}\n',
  },
  {
    name: 'zero_and_negative_infinity/input.scss',
    data: '@use "sass:math";\na {b: math.div(1, rem(0, -infinity))}\n',
  },
  {
    name: 'zero_and_negative_infinity/output.css',
    data: 'a {\n  b: calc(infinity);\n}\n',
  },
  {
    name: 'negative_and_positive_infinity/input.scss',
    data: 'a {b: rem(-5, infinity)}\n',
  },
  {
    name: 'negative_and_positive_infinity/output.css',
    data: 'a {\n  b: -5;\n}\n',
  },
  {
    name: 'positive_and_negative_infinity/input.scss',
    data: 'a {b: rem(5, -infinity)}\n',
  },
  {
    name: 'positive_and_negative_infinity/output.css',
    data: 'a {\n  b: 5;\n}\n',
  },
]
