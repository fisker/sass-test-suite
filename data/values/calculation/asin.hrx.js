// https://github.com/sass/sass-spec/blob/HEAD/spec/values/calculation/asin.hrx

export default [
  {
    name: 'README.md',
    data: "Most of the same behavior tested for `calc()` applies to `asin()`, but for\nterseness' sake isn't tested explicitly.\n",
  },
  {
  ...
  },
  {
    ...
    data: '@function asin($arg) {@return $arg}\na {b: asin(1)}\n',
  },
  {
