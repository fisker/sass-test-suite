// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/selector/unify/complex/combinators/sibling.hrx
...
export default [
  ...
  {
    name: 'and_next_sibling/identical/input.scss',
    data: '@use "sass:selector";\na {b: selector.unify(".c ~ .s1", ".c + .s2")}\n',
  },
  {
    name: 'and_next_sibling/identical/output.css',
    data: 'a {\n  b: .c + .s1.s2;\n}\n',
  },
  {
