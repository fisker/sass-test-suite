// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/selector/is_superselector/complex/sibling.hrx
...
export default [
  ...
  {
    name: 'and_adjacent_sibling/super/input.scss',
    data: '@use "sass:selector";\na {b: selector.is-superselector("d ~ c", "d + c")}\n',
  },
  {
    name: 'and_adjacent_sibling/super/output.css',
    data: 'a {\n  b: true;\n}\n',
  },
  {
    name: 'and_adjacent_sibling/sub/input.scss',
    data: '@use "sass:selector";\na {b: selector.is-superselector("d + c", "d ~ c")}\n',
  },
  {
    name: 'and_adjacent_sibling/sub/output.css',
    data: 'a {\n  b: false;\n}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/first/input.scss',
    data: '@use "sass:selector";\na {b: selector.is-superselector("d ~ c", "d + e + c")}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/first/output.css',
    data: 'a {\n  b: true;\n}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/second/input.scss',
    data: '@use "sass:selector";\na {b: selector.is-superselector("e ~ c", "d + e + c")}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/second/output.css',
    data: 'a {\n  b: true;\n}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/neither/input.scss',
    data: '@use "sass:selector";\na {b: selector.is-superselector("f ~ c", "d + e + c")}\n',
  },
  {
    name: 'and_adjacent_sibling/multiple/neither/output.css',
    data: 'a {\n  b: false;\n}\n',
  },
]
