// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/hsl/one_arg/special_functions/no_alpha.hrx
...
export default [
  ...
  {
    name: 'multi/argument/var/arg_1/of/arg_2/input.scss',
    data: '// var() is substituted before parsing, so it may contain multiple arguments.\na {b: hsl(var(--foo) 50%)}\n',
  },
  {
    name: 'multi/argument/var/arg_1/of/arg_2/output.css',
    data: 'a {\n  b: hsl(var(--foo) 50%);\n}\n',
  },
  {
    name: 'multi/argument/var/arg_1/of/arg_1/input.scss',
    data: 'a {b: hsl(var(--foo))}\n',
  },
  {
    name: 'multi/argument/var/arg_1/of/arg_1/output.css',
    data: 'a {\n  b: hsl(var(--foo));\n}\n',
  },
  {
    name: 'multi/argument/var/arg_2/of/arg_2/input.scss',
    data: 'a {b: hsl(0 var(--foo))}\n',
  },
  {
    name: 'multi/argument/var/arg_2/of/arg_2/output.css',
    data: 'a {\n  b: hsl(0 var(--foo));\n}\n',
  },
]
