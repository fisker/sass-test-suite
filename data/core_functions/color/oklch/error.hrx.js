// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/oklch/error.hrx

export default [
  {
    name: 'unit/lightness/input.scss',
    data: 'a {b: oklch(1px 0.2 3deg)}\n',
  },
  {
  ...
  },
  {
    ...
    data: 'a {b: oklch(1% 0.2 3deg/0.4px)}\n',
  },
  {
  ...
  },
  {
    ...
    data: 'a {b: oklch([1% 0.2 3deg])}\n',
  },
  {
    name: 'list/bracketed/error',
    data: "Error: $channels: Expected an unbracketed list, was [1% 0.2 3deg]\n  ,\n1 | a {b: oklch([1% 0.2 3deg])}\n  |       ^^^^^^^^^^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'list/comma/input.scss',
    data: 'a {b: oklch((1%, 2, 3deg))}\n',
  },
  {
  ...
  },
  {
    ...
    data: "Error: $channels: The oklch color space has 3 channels but (1% 2) has 2.\n  ,\n1 | a {b: oklch(1% 2)}\n  |       ^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'list/too_many_channels/input.scss',
    data: 'a {b: oklch(1% 0.2 3deg 0.4)}\n',
  },
  {
    name: 'list/too_many_channels/error',
    data: "Error: $channels: The oklch color space has 3 channels but (1% 0.2 3deg 0.4) has 4.\n  ,\n1 | a {b: oklch(1% 0.2 3deg 0.4)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
