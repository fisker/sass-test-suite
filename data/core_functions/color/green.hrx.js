// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/green.hrx
...
export default [
  ...
  },
  {
    ...
    data: "Error: color.green() is only supported for legacy colors. Please use color.channel() instead with an explicit $space argument.\n  ,\n2 | a {b: color.green(color(srgb 1 1 1))}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n  input.scss 2:7  root stylesheet\n",
  },
]
