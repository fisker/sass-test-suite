// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/lab/special_functions/alpha.hrx
...
export default [
  ...
  {
    name: 'calc/calculation/with_slash/input.scss',
    data: "@use 'core_functions/color/utils';\n@include utils.inspect(lab(1% 2 3 / calc(var(--a) / 2)));\n",
  },
  {
    name: 'calc/calculation/with_slash/output.css',
