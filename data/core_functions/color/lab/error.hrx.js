// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/lab/error.hrx

export default [
  {
    name: 'unit/lightness/input.scss',
    data: 'a {b: lab(1px 2 3)}\n',
  },
  {
  ...
  {
    name: 'type/b/direct/input.scss',
    data: 'a {b: lab(1% 2 c)}\n',
  },
  {
    name: 'type/b/direct/error',
    data: "Error: $channels: Expected b channel to be a number, was c.\n  ,\n1 | a {b: lab(1% 2 c)}\n  |       ^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'type/b/slash/input.scss',
    data: 'a {b: lab(1% 2 c / 0.4)}\n',
  },
  {
    name: 'type/b/slash/error',
    data: "Error: $channels: Expected b channel to be a number, was c.\n  ,\n1 | a {b: lab(1% 2 c / 0.4)}\n  |       ^^^^^^^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
  ...
  {
    name: 'type/alpha/slash/input.scss',
    data: "@use 'sass:list';\na {b: lab(1% 2 3 / c)}\n",
  },
  {
    name: 'type/alpha/slash/error',
    data: "Error: $channels: c is not a number.\n  ,\n2 | a {b: lab(1% 2 3 / c)}\n  |       ^^^^^^^^^^^^^^^\n  '\n  input.scss 2:7  root stylesheet\n",
  },
  {
  ...
  },
  {
    ...
    data: "Error: $channels: The lab color space has 3 channels but (1% 2) has 2.\n  ,\n1 | a {b: lab(1% 2)}\n  |       ^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'list/too_many_channels/input.scss',
    data: 'a {b: lab(1% 2 3 0.4)}\n',
  },
  {
    name: 'list/too_many_channels/error',
    data: "Error: $channels: The lab color space has 3 channels but (1% 2 3 0.4) has 4.\n  ,\n1 | a {b: lab(1% 2 3 0.4)}\n  |       ^^^^^^^^^^^^^^^\n  '\n  input.scss 1:7  root stylesheet\n",
  },
  {
