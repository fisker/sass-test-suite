// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/fade_out.hrx

export default [
  {
    name: 'max/input.scss',
    data: 'a {b: fade-out(rgba(red, 0.5), 1)}\n',
  },
  {
    name: 'max/output.css',
    data: 'a {\n  b: rgba(255, 0, 0, 0);\n}\n',
  ...
  },
  {
    ...
    data: "DEPRECATION WARNING [global-builtin]: Global built-in functions are deprecated and will be removed in Dart Sass 3.0.0.\nUse color.adjust instead.\n\nMore info and automated migrator: https://sass-lang.com/d/import\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0.5)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n\nDEPRECATION WARNING [color-functions]: fade-out() is deprecated. Suggestions:\n\ncolor.scale($color, $alpha: -100%)\ncolor.adjust($color, $alpha: -0.5)\n\nMore info: https://sass-lang.com/d/color-functions\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0.5)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'min/input.scss',
    data: 'a {b: fade-out(rgba(red, 0.5), 0)}\n',
  },
  {
    name: 'min/output.css',
    data: 'a {\n  b: rgba(255, 0, 0, 0.5);\n}\n',
  ...
  {
    name: 'min/warning',
    data: "DEPRECATION WARNING [global-builtin]: Global built-in functions are deprecated and will be removed in Dart Sass 3.0.0.\nUse color.adjust instead.\n\nMore info and automated migrator: https://sass-lang.com/d/import\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n\nDEPRECATION WARNING [color-functions]: fade-out() is deprecated. Suggestion:\n\ncolor.adjust($color, $alpha: 0)\n\nMore info: https://sass-lang.com/d/color-functions\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'middle/input.scss',
    data: 'a {b: fade-out(rgba(red, 0.5), 0.14)}\n',
  },
  {
  ...
  {
    name: 'middle/warning',
    data: "DEPRECATION WARNING [global-builtin]: Global built-in functions are deprecated and will be removed in Dart Sass 3.0.0.\nUse color.adjust instead.\n\nMore info and automated migrator: https://sass-lang.com/d/import\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0.14)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n\nDEPRECATION WARNING [color-functions]: fade-out() is deprecated. Suggestions:\n\ncolor.scale($color, $alpha: -28%)\ncolor.adjust($color, $alpha: -0.14)\n\nMore info: https://sass-lang.com/d/color-functions\n\n  ,\n1 | a {b: fade-out(rgba(red, 0.5), 0.14)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  '\n    input.scss 1:7  root stylesheet\n",
  },
  {
    name: 'named/input.scss',
    data: 'a {b: fade-out($color: rgba(red, 0.5), $amount: 0.14)}\n',
  },
  {
  ...
  },
  {
    ...
    data: 'a {b: transparentize($color: rgba(red, 0.5), $amount: 0.14)}\n',
  },
  {
    name: 'transparentize/output.css',
    data: 'a {\n  b: rgba(255, 0, 0, 0.36);\n}\n',
  },
  {
    name: 'transparentize/warning',
  ...
  },
  {
    ...
    data: 'a {b: fade-out(color(srgb 1 1 1), 0.1)}\n',
  },
  {
