// https://github.com/sass/sass-spec/blob/HEAD/spec/core_functions/color/change/error/type.hrx
...
export default [
  ...
  {
    name: 'red/error',
    data: 'Error: $red: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $red: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  {
    name: 'green/error',
    data: 'Error: $green: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $green: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  {
    name: 'blue/error',
    data: 'Error: $blue: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $blue: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
    name: 'hue/input.scss',
  ...
  {
    name: 'hue/error',
    data: 'Error: $hue: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $hue: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  },
  {
    ...
    data: 'Error: $saturation: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $saturation: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  },
  {
    ...
    data: 'Error: $lightness: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $lightness: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  {
    name: 'alpha/error',
    data: 'Error: $alpha: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $alpha: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
    name: 'quoted_none/input.scss',
    data: '@use "sass:color";\na {b: color.change(red, $alpha: "none")}\n',
  },
  {
    name: 'quoted_none/error',
    data: 'Error: $alpha: "none" is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $alpha: "none")}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  },
  {
    ...
    data: 'Error: $blackness: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $blackness: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
  ...
  },
  {
    ...
    data: 'Error: $whiteness: c is not a number or unquoted "none".\n  ,\n2 | a {b: color.change(red, $whiteness: c)}\n  |       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  \'\n  input.scss 2:7  root stylesheet\n',
  },
  {
